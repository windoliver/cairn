...
/// Transport envelope for federation operations. Carries either a share proposal or a revocation (brief §12.a).
...
pub struct FederationEnvelope {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub manifest: Option<Vec<MemoryRecordStub>>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
/// Minimal wire representation of a memory record included in a federation envelope manifest (brief §12.a).
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
#[serde(deny_unknown_fields)]
...
/// Body-free payload for a signed share-link grant (brief §12.a).
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
#[serde(deny_unknown_fields)]
...
/// Signed share link authorizing a bounded grant (brief §12.a).
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
#[serde(deny_unknown_fields)]
