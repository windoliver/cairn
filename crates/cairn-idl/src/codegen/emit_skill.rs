...
fn push_trigger_table(s: &mut String) {
    ...
    s.push_str("| \"forget what I said about W\" | `cairn forget --record $(cairn search \"W\" --mode keyword --limit 1 --json \\| jq -r '.hits[0].id')` |\n");
    s.push_str("| \"what do you know about K?\" | `cairn search \"K\" --mode keyword --limit 10 --json` |\n");
    s.push_str("| \"load my preferences for this session\" | `cairn assemble_hot --session ${SESSION_ID} --json` |\n");
    s.push_str("| before answering any non-trivial question | `cairn search \"$USER_INTENT\" --mode keyword --limit 5 --json` |\n");
