...
use super::skill_compat::required_excluding_const;
...
fn push_verb_examples(s: &mut String, verb: &VerbDef) {
    ...
    let required_per_cmd = required_args_per_command(verb, cmds.len());
...
fn required_args_per_command(verb: &VerbDef, cmd_count: usize) -> Vec<BTreeSet<String>> {
