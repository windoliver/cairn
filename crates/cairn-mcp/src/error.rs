...
pub enum McpTransportError {
    ...
    /// MCP service failed after transport startup.
...
/// Backwards-compatible transport error name used by the MCP entry point.
pub type TransportError = McpTransportError;
