...
const M0012_EDGES_UPDATES_DST_IDX: &str = include_str!("sql/0012_edges_updates_dst_idx.sql");
...
pub(crate) const MIGRATION_SOURCES: &[(i64, &str, &str)] = &[
    ...
    (
        12,
        "0012_edges_updates_dst_idx",
        M0012_EDGES_UPDATES_DST_IDX,
    ),
];
...
pub fn migrations() -> Migrations<'static> {
    Migrations::new(vec![
        ...
        M::up(M0012_EDGES_UPDATES_DST_IDX),
    ])
}
