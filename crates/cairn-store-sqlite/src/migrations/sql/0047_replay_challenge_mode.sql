...
CREATE TEMP TABLE _mig0047_drift_guard (
  msg TEXT NOT NULL CHECK (msg = 'ok')
);
INSERT INTO _mig0047_drift_guard (msg)
  SELECT 'migration 0047: unexpected schema object on used / issuer_seq / outstanding_challenges: '
         || type || ':' || name
    FROM sqlite_schema
   WHERE (
...
DROP TABLE _mig0047_drift_guard;
...
INSERT INTO schema_migrations (migration_id, name, sql_hash, applied_at)
  VALUES (47, '0047_replay_challenge_mode', '', strftime('%s','now') * 1000);
