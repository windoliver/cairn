...
| §14 Privacy and consent | #17, #26, #50, #58, #88, #93–#96, #121–#122 | — | Redaction, consent, policy traces, lint, forget, ReBAC, share consent. #50 contributes privacy-by-construction for key material: signing key bytes are never written to the vault filesystem, and the `usr:` prefix purge eliminates a class of identity-namespace leakage. |
