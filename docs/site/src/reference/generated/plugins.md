...
| `cairn-store-sqlite` | `MemoryStore` | `[0.3.0, 0.5.0)` | `bundled:cairn-store-sqlite` | `{"fts":true,"graph_edges":true,"per_record_consent_model":true,"transactions":true,"vector":false}` |
