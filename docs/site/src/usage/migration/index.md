...
| WAL state machines | New states append; existing transitions never change semantics ([CLAUDE.md §6.11](https://github.com/windoliver/cairn/blob/main/CLAUDE.md#611-sqlite--store)). |
